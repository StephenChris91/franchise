  ...
  return (
    ...
    <Footer container className="bg-black text-white px-4 py-10 rounded-none border-t border-gray-700" id='footer'>
      <div className="w-full max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Logo + Description */}
        <div>
          <h2 className="text-2xl font-bold text-gold mb-3">The Franchise Church</h2>
        ...
        <div className="flex flex-col gap-2 text-sm">
          ...
          <Link href="/" className="text-gray-50 hover:text-gold">Home</Link>
          <Link href="/about" className="text-gray-50 hover:text-gold">About Us</Link>
        </div>
